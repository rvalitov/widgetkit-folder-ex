...
<div class="uk-form uk-form-horizontal uk-folderex" ng-controller="folderExCtrl as folder">
	...
	<div class="uk-form-row">
		<span class="uk-form-label" for="wk-path">{{ 'Folder Path' | trans}}<span data-uk-tooltip="'cls':'uk-folderex-tooltip'" title="{{ 'The folder where the images are stored. This field is mandatory.' |trans}}"><i></i></span></span>
	...
	<div class="uk-form-row">
		<span class="uk-form-label" for="wk-regexp">{{ 'RegExp Pattern' | trans}}<span data-uk-tooltip="'cls':'uk-folderex-tooltip'" title="{{ 'RegExp string used for filtering files. It allows to select only files that match the pattern. If this string is empty, then a default pattern is used that matches images with the following extensions: jpg, jpeg, gif, png. Read manual for more information.' |trans}}"><i></i></span></span>
		<div class="uk-form-controls">
	...
	<div class="uk-form-row">
		<span class="uk-form-label" for="wk-order">{{'Order' | trans}}<span data-uk-tooltip="'cls':'uk-folderex-tooltip'" title="{{ 'This field defines the sorting options applied to the files.' |trans}}"><i></i></span></span>
		<div class="uk-form-controls">
	...
	<div class="uk-form-row">
		<span class="uk-form-label">{{'Title' | trans}}<span data-uk-tooltip="'cls':'uk-folderex-tooltip'" title="{{ 'The title of each image is generated automatically from its file name. The options below control how the file name should be processed.' |trans}}"><i></i></span></span>
